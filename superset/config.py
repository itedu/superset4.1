...
TALISMAN_CONFIG = {
    "content_security_policy": {
        ...
        "script-src": ["'self'", "'strict-dynamic'","'https://api.map.baidu.com'"],
    },
...
TALISMAN_DEV_CONFIG = {
    "content_security_policy": {
        ...
        "img-src": [
            ...
            "https://api.map.baidu.com/",
            "https://miao.baidu.com/",
            "https://mapapip1.bdimg.com/",
            "https://mapapip0.bdimg.com/",
            "https://mapapip2.bdimg.com/"
        ],
        "worker-src": ["'self'", "blob:"],
        "connect-src": [
            "'self'",
        ...
        "script-src": ["'self'", "'unsafe-inline'", "'unsafe-eval'","https://mapapip2.bdimg.com/","https://mapapip1.bdimg.com/","https://api.map.baidu.com/","https://dlswbr.baidu.com/","https://miao.baidu.com/","https://static.tieba.baidu.com/"],
    },
    "content_security_policy_nonce_in": ["script-src"],
    "force_https": False,
    "session_cookie_secure": False,
